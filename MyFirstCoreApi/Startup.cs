...
using MyFirstCoreApi.Controllers;
...
namespace MyFirstCoreApi
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<ProductsDbContext>(option => option.UseSqlServer(@"Data Source=LAPTOP-B92Q5MCS\SQLEXPRESS;Initial Catalog=ProductsDb;Trusted_Connection=True"));
        }
